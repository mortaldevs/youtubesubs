...
class Youtube_Subs_Widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			...
			array( 'description' => esc_html__( 'Widget for displaying Youtube Subscribers', 'yts_domain' ), ) // Args
		);
	}
	...
	public function form( $instance ) {
        ...
        $channel = ! empty( $instance['channel'] ) ? $instance['channel'] : esc_html__( 'tseries', 'yts_domain' );
